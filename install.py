...
def prepare(rType="MAIN"):
    ...
    if rType == "MAIN":
        ...
        os.system("add-apt-repository 'deb [arch=amd64,arm64,ppc64el] https://archive.mariadb.org/mariadb-10.5/repo/ubuntu focal main'  > /dev/null")
        os.system("apt-get update > /dev/null")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI 22f Ubuntu %s Installer - Silenttrix CK MOD" % rVersion, col.GREEN, 2)
    print(" ")
